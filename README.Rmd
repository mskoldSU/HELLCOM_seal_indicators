...
Note that the *Pregnancy rate (combined)* differs from the report's *combined indicator* in the sense that equal weight is given to all seals in a year rather than to yearly country indices.
